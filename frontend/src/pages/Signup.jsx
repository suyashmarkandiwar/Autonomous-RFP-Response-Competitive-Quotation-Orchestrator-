...
export default function Signup() {
    ...
    return (
        <div style={{ fontFamily: "'Inter','Segoe UI',sans-serif", minHeight: '100vh', background: '#080c1a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, position: 'relative', overflow: 'hidden' }}>
            ...
            {/* Background orbs */}
            <div style={{ position: 'absolute', width: 500, height: 500, borderRadius: '50%', background: 'rgba(139,92,246,0.15)', filter: 'blur(80px)', top: '-150px', right: '-150px', animation: 'pulse-glow 4s ease-in-out infinite', pointerEvents: 'none' }} />
            <div style={{ position: 'absolute', width: 400, height: 400, borderRadius: '50%', background: 'rgba(6,182,212,0.1)', filter: 'blur(80px)', bottom: '-100px', left: '-100px', animation: 'pulse-glow 4s 2s ease-in-out infinite', pointerEvents: 'none' }} />
            ...
            <div style={{ width: '100%', maxWidth: 420, animation: 'fadeInUp 0.6s ease both' }}>
                ...
                <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.09)', borderRadius: 24, padding: '40px 36px', backdropFilter: 'blur(12px)' }}>
                    ...
                    <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.4)', marginBottom: 28 }}>Start generating AI-powered quotations today</p>

                    {success ? (
                        <div style={{ padding: '16px', borderRadius: 12, background: 'rgba(16,185,129,0.12)', border: '1px solid rgba(16,185,129,0.3)', color: '#6ee7b7', fontSize: 14, textAlign: 'center' }}>
                        ...
                        <>
                            ...
                            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                                <div>
                                    ...
                                    <input id="signup-email" type="email" required placeholder="you@company.com" className="auth-input" value={email} onChange={e => setEmail(e.target.value)} />
                                </div>
                                <div>
                                ...
                                <button id="signup-submit" type="submit" disabled={loading} className="auth-btn" style={{ marginTop: 8 }}>
                    ...
                    <p style={{ marginTop: 24, textAlign: 'center', fontSize: 14, color: 'rgba(255,255,255,0.4)' }}>
                        ...
                        <button onClick={() => navigate('/login')} style={{ background: 'none', border: 'none', color: '#818cf8', cursor: 'pointer', fontWeight: 600, padding: 0, fontSize: 14 }}>
                            Login
                        </button>
                    </p>
                </div>
